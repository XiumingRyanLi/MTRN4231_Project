    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_interfaces.action.GripperCommand_Goal')
            logger.debug(
...
class GripperCommand_Goal(metaclass=Metaclass_GripperCommand_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.close = kwargs.get('close', bool())
...
class Metaclass_GripperCommand_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GripperCommand_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_GripperCommand_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GripperCommand_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperCommand_SendGoal_Request(metaclass=Metaclass_GripperCommand_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'custom_interfaces/GripperCommand_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'action'], 'GripperCommand_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_interfaces.action._gripper_command import GripperCommand_Goal
...
class Metaclass_GripperCommand_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GripperCommand_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.action import _gripper_command
...
class GripperCommand_SendGoal(metaclass=Metaclass_GripperCommand_SendGoal):
    from custom_interfaces.action._gripper_command import GripperCommand_SendGoal_Request as Request
    from custom_interfaces.action._gripper_command import GripperCommand_SendGoal_Response as Response
...
class GripperCommand_GetResult_Response(metaclass=Metaclass_GripperCommand_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'custom_interfaces/GripperCommand_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'action'], 'GripperCommand_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_interfaces.action._gripper_command import GripperCommand_Result
...
class Metaclass_GripperCommand_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GripperCommand_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperCommand_GetResult(metaclass=Metaclass_GripperCommand_GetResult):
    from custom_interfaces.action._gripper_command import GripperCommand_GetResult_Request as Request
    from custom_interfaces.action._gripper_command import GripperCommand_GetResult_Response as Response
...
class Metaclass_GripperCommand_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GripperCommand_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperCommand_FeedbackMessage(metaclass=Metaclass_GripperCommand_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'custom_interfaces/GripperCommand_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'action'], 'GripperCommand_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from custom_interfaces.action._gripper_command import GripperCommand_Feedback
...
class Metaclass_GripperCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GripperCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperCommand(metaclass=Metaclass_GripperCommand):
    ...
    from custom_interfaces.action._gripper_command import GripperCommand_Goal as Goal
    # The result message defined in the action definition.
    from custom_interfaces.action._gripper_command import GripperCommand_Result as Result
    # The feedback message defined in the action definition.
    from custom_interfaces.action._gripper_command import GripperCommand_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from custom_interfaces.action._gripper_command import GripperCommand_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from custom_interfaces.action._gripper_command import GripperCommand_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from custom_interfaces.action._gripper_command import GripperCommand_FeedbackMessage as FeedbackMessage
